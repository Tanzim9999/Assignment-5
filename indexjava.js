...
document.getElementById("donateNow2").addEventListener("click", function () {
    ...
    if (typeof donateAmount !== 'number' || isNaN(donateAmount) || donateAmount <= 0 || donateAmount > balance) {
      alert("Sorry Invalid Format or Donation Amount is more than your Balance");
    } else {
      // Static model appear
      document.getElementById("alert").classList.remove("hidden");
...
document.getElementById("donateNow3").addEventListener("click", function () {
    ...
    if (typeof donateAmount !== 'number' || isNaN(donateAmount) || donateAmount <= 0 || donateAmount > balance) {
      return alert("Sorry Invalid Format or Donation Amount is more than your Balance");
    } else {
      // Static model appear
      document.getElementById("alert").classList.remove("hidden");
      // Calculation stuffs
